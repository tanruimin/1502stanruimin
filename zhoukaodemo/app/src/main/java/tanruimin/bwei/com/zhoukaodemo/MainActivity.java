...
public class MainActivity extends SlidingFragmentActivity {
    public static final String url="http://appapi.kangzhi.com/app/kzdrugs/index?uid=1476860172&catid=&sort=default&page=1";
    private ListView mMain_listvew;
    private Handler mHandler=new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            mMain_listvew.setAdapter(new Adapter<GsonBean.DataBean>(MainActivity.this,data1) {
                @Override
    ...
    private void initView() {
        mMain_listvew = (ListView) findViewById(R.id.main_listview);
    }
