 ...
 * function:
 */
public class CCActivity extends SlidingFragmentActivity {
    public static final String url="http://appapi.kangzhi.com/app/kzdrugs/index?uid=1476860172&catid=%E4%B8%AD%E8%8D%AF&sort=default&page=1";
    private Handler mHandler=new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            mChinieseList.setAdapter(new Adapter<GsonBean.DataBean>(CCActivity.this,data1) {
                @Override
    ...
    private ListView mChinieseList;
    ...
    private void initView() {
        mChinieseList = (ListView) findViewById(R.id.chiniese_listview);
    }
